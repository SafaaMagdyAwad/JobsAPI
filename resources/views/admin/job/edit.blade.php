    ...
    <div class="form-group mb-3 row">
      ...
      <div class="col-md-10">
          <select name="job_nature" class="form-control">
              <option value="Full Time" @selected(old('job_nature',$job->job_nature) == "Full Time")>Full Time</option>
              <option value="Part Time" @selected(old('job_nature',$job->job_nature) == "Part Time")>Part Time</option>
          </select>
      </div>
    </div>
