    ...
    <div class="row justify-content-center">
      ...
      <div class="col-lg-8 col-md-6 col-12 card-body">
        <div class="mb-4 text-center py-2">
          <h2 class="fw-bold bg-light card-header">{{ __('admin/jobApplication.name') }}  ::  {{$data->name}}</h2>
        </div>
        <div class="mb-4 text-center py-2">
          <p class="fw-bold bg-light card-header">{{ __('admin/jobApplication.email') }} ::  {{$data->email}}</p>
        </div>
        <div class="mb-4 text-center py-2">
