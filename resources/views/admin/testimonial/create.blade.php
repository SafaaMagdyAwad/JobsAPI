      ...
      <div class="bg-light p-5 rounded">
        ...
        <form action="{{route('testimonials.store')}}" method="post" class="px-md-5" enctype="multipart/form-data">
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="text" placeholder="job" name="job" class="form-control py-2" value="{{old('job')}}" />
            </div>
          </div>
        ...
        <hr>
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
                <textarea name="message" placeholder="Enter message" cols="30" rows="5"class="form-control py-2"  >{{old('message')}}</textarea>
            </div>
          </div>
